...
import './App.css';
import { WeatherDayFr } from '../WeatherDayFr/WeatherDayFr';
...
export const App = () => {
  ...
  useEffect(() => {
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=Bogota,CO&APPID=d0fed389831e829ff46ed9cf1e3950ca`)
      .then(res => res.json())
      .then(res => setIcono(res.weather[0].icon));
  ...
  return (
    <div>
      <WeatherDay temperatura={temperatura} ciudad={ciudad} icono={icono}/>
