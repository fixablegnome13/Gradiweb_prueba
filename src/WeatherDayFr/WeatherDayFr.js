import './styles.weatherfr.css';
import React from "react";
import { useEffect, useState } from 'react';


export const WeatherDayFr = () => {
    ...
    useEffect(() => {
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=Paris,FR&APPID=c550430803358da3dcf601a18a49d4d0
        `)
            .then(res => res.json())
    ...
    return (
        <div>
            <div className="containerFr">
                ...
                <div className="divImgFr">
                    <img className="imagen" alt={icon1} src={`https://openweathermap.org/img/wn/${icon1}@2x.png`} />
                </div>
                <div className="divWeatherfr">{Math.round(tempSw)} <small><sup>°C</sup></small></div>
